const videos = [
    ...
    { title: "Acionamento do prestador + Análise de valores (1/3)", src: "../Apresentação Sistema/Acionamento do prestador + Análise de valores/Acionamento do prestador + Análise de valores-1.mp4" },
    { title: "Acionamento do prestador + Análise de valores (2/3)", src: "../Apresentação Sistema/Acionamento do prestador + Análise de valores/Acionamento do prestador + Análise de valores-2.mp4" },
    { title: "Acionamento do prestador + Análise de valores (3/3)", src: "../Apresentação Sistema/Acionamento do prestador + Análise de valores/Acionamento do prestador + Análise de valores-3.mp4" },
